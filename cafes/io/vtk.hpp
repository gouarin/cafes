...
// PetscErrorCode saveInVTK3d(const char* path, const char* filename, Vec sol, StokesCtx *user){
//   PetscErrorCode ierr;
//   DM             dau, dap;
//   DMDALocalInfo  infou, infop;
//   Vec            solu, solp;
...
//       for (int i=infop.gxs; i<infop.gxs+infop.gxm; i++)
//         {
//           pressurePoints->InsertNextPoint(2*i*user->hx, 2*j*user->hy, 2*k*user->hz);
//           pressure->InsertNextValue(psolp[k][j][i]);
//       }
...
//       for (int i=infou.gxs; i<infou.gxs+infou.gxm; i++)
//         {
//           velocityPoints->InsertNextPoint(i*user->hx, j*user->hy, k*user->hz);
//           velocity->InsertNextTuple3(psolu[k][j][i][0], psolu[k][j][i][1], psolu[k][j][i][2]);
//       }
