...
int main(int argc, char **argv)
{
    ...
    auto se1 = cafes::make_circle( {.3,.5}, .1, 0);
    auto se2 = cafes::make_circle( { .6, .5}, .1, 0);
    std::vector<cafes::particle<decltype(se1)>> pt{ cafes::make_particle_with_force(se1, {0.,0.}, 0.),
                                                    cafes::make_particle_with_force(se1, {0.,0.}, 0.)
                                                 };
